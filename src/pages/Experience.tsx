...
const skills = {
  ...
  vesta: ['React', 'TypeScript', 'Material-UI', 'PHP Laravel','Azure', 'MySql','GitHub'],
                ...
                <Box>
                  ...
                  <Box>
                    {skills.blackcoffer.map((skill) => (
                      <Chip key={skill} label={skill} style={{ marginRight: '0.5rem', marginBottom: '0.5rem', backgroundColor: '#00FF7F', color: '#2c3e50' }} />
                    ))}
                  </Box>
                </Box>
              </Box>
